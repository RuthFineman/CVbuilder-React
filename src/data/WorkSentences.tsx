...
const sentences: Record<string, string[]> = {
  ...
  "אדריכל":[
  "ניהול מוצלח של התכנון והפיתוח של מספר פרוייקטים מסחריים בקנה מידה גדול.",
 "פיתוח פתרונות חדשניים לאתגרי עיצוב מורכבים.",
 "הפקת שרטוטים ותכניות מפורטות לפרוייקטי בנייה.",
 "הובלת ביקורים באתר להבטחת עמידה במפרטי התכנון.",
 "שיתוף פעולה עם לקוחות וקבלנים להבטחת השגת המטרות.",
 "הצגת תפיסות עיצוביות בפני צוותי פרוייקטים, בעלי עניין ולקוחות.",
 "פיקוח על תהליכי הבנייה להבטחת איכות ודיוק.",
 "עריכת מחקרי סבירות לזיהוי בעיות בנייה אפשריות.",
 " שימוש ב-Revit, AutoCAD, ו-Sketchup ליצירת עיבודים תלת-מימדיים של בניינים.",
 " שיתוף פעולה עם מהנדסים, מודדים, ואנשי מקצוע נוספים לאורך תהליך העיצוב."
]
};
